...
export class PlaidService {
  ...
  static async exchangePublicToken(userId: string, publicToken: string, metadata: any): Promise<void> {
  ...
  static async createUpdateLinkToken(userId: string, portfolioId: string): Promise<string> {
